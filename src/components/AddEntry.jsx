...
export default function AddEntry() {
  let { entries, setEntries ,totalIncome,totalExpense} = useEntries();
      ...
      <div className="mx-auto max-w-xl px-5">
        <form
          ...
          onSubmit={(e) => {
            ...
            if(totalIncome>=totalExpense+parseFloat(value) && type==='expense'){
          ...
          else if(totalIncome<totalExpense+parseFloat(value) && type==='expense')
          {alert("Not have enough money to expense!!!");}
          else {  
            setEntries([
              ...entries,
              {
